        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center items-center h-64">
            <div className="relative">
              <div className="animate-spin rounded-full h-16 w-16 border-4 border-indigo-400/30 border-t-indigo-400"></div>
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400 to-purple-400 opacity-20 blur-xl"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 px-4 md:px-8 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-16">
            ...
            <h3 className="mt-6 text-xl font-bold text-white">Error loading your requests</h3>
            <p className="mt-2 text-slate-300">There was a problem fetching your lost item requests.</p>
            <button 
              onClick={refetch}
              className="mt-6 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl font-semibold shadow-2xl hover:shadow-indigo-500/25 transform hover:scale-105 hover:-translate-y-1 transition-all duration-300"
            >
              Try Again
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center mb-8">
            <Link 
              ...
              className="group flex items-center text-indigo-400 hover:text-indigo-300 transition-all duration-300"
            >
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-12 text-center">
              <div className="relative inline-flex mb-6">
                <div className="bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl p-4 shadow-2xl">
                  <Tag className="h-10 w-10 text-white" />
                </div>
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl blur-xl opacity-30"></div>
              </div>
              <h3 className="text-2xl font-bold text-white mb-3">No lost item requests posted yet</h3>
              <p className="text-slate-300 text-lg mb-8">When you post a lost item request, it will appear here.</p>
              <Link
                to="/student/post-lost-item"
                className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white rounded-2xl font-semibold shadow-2xl hover:shadow-indigo-500/25 transform hover:scale-105 hover:-translate-y-1 transition-all duration-300"
              >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="ml-6">
            ...
            <p className="text-slate-300 mt-1">{items.length} request{items.length !== 1 ? 's' : ''} posted</p>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="relative group max-w-md w-full">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8">
                ...
                <p className="text-slate-300 mb-8">Are you sure you want to delete this lost item request? This action cannot be undone.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((item, index) => (
            ...
            >
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
              
              {/* Card */}
              <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:bg-white/10 hover:border-indigo-500/50 transform hover:-translate-y-2 transition-all duration-500">
                {/* Image */}
                <div className="relative h-48 overflow-hidden">
                  {item.imageUrl ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center">
                      <div className="relative">
                        <Tag className="h-16 w-16 text-indigo-300" />
                ...
                {/* Content */}
                <div className="p-6">
                  <h3 className="font-bold text-xl text-white mb-4 line-clamp-1 group-hover:text-indigo-300 transition-colors duration-300">
                    {item.title}
                  </h3>

                  <div className="space-y-3 mb-6">
                    <div className="flex items-start">
                      <div className="bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg p-1.5 mr-3 flex-shrink-0">
                        <Tag className="h-3.5 w-3.5 text-white" />
                      </div>
                      <p className="text-sm text-slate-300 line-clamp-1">{item.name}</p>
                    </div>
                    <div className="flex items-start">
                      <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg p-1.5 mr-3 flex-shrink-0">
                        <MapPin className="h-3.5 w-3.5 text-white" />
                      </div>
                      <p className="text-sm text-slate-300 line-clamp-1">{item.landmark}</p>
                    </div>
                    <div className="flex items-start">
                      <div className="bg-gradient-to-r from-pink-500 to-cyan-500 rounded-lg p-1.5 mr-3 flex-shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Link
                      ...
                      className="group/btn flex items-center justify-center py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-medium shadow-xl hover:shadow-indigo-500/25 transform hover:scale-105 transition-all duration-300"
                    >
